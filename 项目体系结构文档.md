...
## 1. Abstract	[>](https://github.com/liyihann/react/wiki/01.Abstract)

## 2. Introduction	[>](https://github.com/liyihann/react/wiki/02.Introduction)
...
## 3. Stakeholders	[>](https://github.com/liyihann/react/wiki/03.Stakeholders)
...
![Power Interest Grid](https://ws2.sinaimg.cn/large/006tNbRwly1fwzalsrhuaj30zo0pcdsp.jpg)
...
## 4. Context View	[>](https://github.com/liyihann/react/wiki/04.Context-View)
...
### 4.1 System Scope & Responsiblities
...
Figure 1 shows the external entities surrounding React's environment and their relationships.

![externalentities](https://ws2.sinaimg.cn/large/006tNbRwly1fwzar69um2j31700mutkr.jpg)
...
## 5. Development View	[>](https://github.com/liyihann/react/wiki/05.Development-View)
...
### 5.2 Codeline Organization

Figure 1 shows organization of React's code in four sections.

![codeline](https://ws3.sinaimg.cn/large/006tNbRwly1fwr97d9ry3j319u0pi0z0.jpg)

**Functionality**

The functionality part contains the components that are responsible for functions of the project. Generally, `packages` contains the main and fundamental part of the codes. The `react` directory inside `packages` is the core components of all the codes. It has the essential functions and works together with `react-dom` and `react-native`. And  `react-art`  is a JavaScript library used for creating vectorgraph. The package `react-dom`  serves as the entry point to the DOM and server renderers for React. It is intended to be paired with the generic React package, which is shipped as `react` to npm. What's more, the `scripts` directory contains files that provide additional functions in React.

**Development and Deployment**

The development and deployment section contains code that is used in the completement and development of React. They are mainly used in developing React rather than affecting the functionality of React. The directory `fixtures`  includes the test examples of React. The `art` directory contains the test examples of vector controls. The `attribute-behavior` tests every property that the controls may bring. The rest of the directories have various testing functions.

**Documentation**

The documentation section contains codes used to demonstrate and generate the documentation of React.  They are offen written in Markdown. For example, `README.md`  contains the usage and instructions of using React and `CHANGELOG.md`  contains the development progress of React.
...
### 5.3 Module Organization(Logical View?)

## 6. Deployment View [>](https://github.com/liyihann/react/wiki/06.Deployment-View)
...
### 6.1 Third-Party Software Requirements
...
## 7. Functional View	[>](https://github.com/liyihann/react/wiki/07.Functional-View)

In this section, we will discuss the most important and unique functionalities of React. This will involve the main roles, functions features, internal implementations, and usage for developers of these functionalties, which are closely related to the architecture of the entire project.
...
> JSX gets compiled to `React.createElement()` calls which return plain JavaScript objects called "React elements". To get a basic introduction to JSX see the docs here and find a more in-depth toturial on JSX here.
>
...
5. The method named "paint" of each node will be called to show the node.
  ...
  <img src="https://i.loli.net/2018/10/22/5bcd8c4defcb5.jpg" alt="Workflow of Browser Engines" width="70%" />   
...
<img src="https://i.loli.net/2018/10/22/5bcd8c8f7cccb.png" alt="Examples of Different Cases of Diff Algorithm" width="70%" />
...
<img src="https://i.loli.net/2018/10/22/5bcd8cc46e4ee.png" alt="Example: Add a Node" width="40%" />

There are several ways to solve this problem.

<img src="https://i.loli.net/2018/10/22/5bcd8cc49d173.png" alt="One Simple Way to Add a Node" width="40%" />
...
<img src="https://i.loli.net/2018/10/22/5bcd8cc4c5c65.png" alt="A Better Way to Add a Node" width="40%" />
...
In any application, data is necessary. React's data flow from top to bottom, that is from parent comppnent to child conponent and data is stored in **props** and **state**.
...
There are 3 states of lifestyle 

1. initialization
2.  update 
3. destruction

![lifecycle](https://ws4.sinaimg.cn/large/006tNbRwly1fwzaz94mx2j30kk0p0dhq.jpg)

## 8. Performance and Scalability Perspective	[>](https://github.com/liyihann/react/wiki/08.Performance-and-Scalability-Perspective)

## 9. Technical Debt	[>](https://github.com/liyihann/react/wiki/09.Technical-Debt)

After the analysis about React.js, we now can have a closer and deeper look into the source code. There has been some changes happened to the system. Thus we have to do something to indentify functionality that is added to it. Technical is exactly the concept that reflects the exxtra development work that arises from wrong implementations. When code which is easy to implement in a short period is used in the place of an overall solution, long-run adjustments needs to be made. Here's two ways of doing it, static code analysis and manual code inspection. And this section is not only related to the code, but also associated with the documentation or the low testing coverage.
...
To have a better view of React.js, we choose CODEBEAT and CodeFactor as our static analysis tools. The two tools can inspect codes separately in order to rate them from A to F. They concludes the outcome of code complexity, code issues, and code duplication. These examples of metrics are taken into consideration. What's more, the two tools are free to be accessed.
...
<img src="https://ws4.sinaimg.cn/large/006tNbRwly1fwvvqzcnu8j30ro08sjsa.jpg" width="60%" />
...
<img src="https://ws2.sinaimg.cn/large/006tNbRwly1fwvvx5ueytj31kw0ubgtu.jpg" width="100%" />
...
<img src="https://ws1.sinaimg.cn/large/006tNbRwly1fwvw5pj5gej31ig0f8ach.jpg" width="90%" />
...
Meanwhile, CodeFactor analyzed and rated 141 external libraries referenced by React. The following figure(right) is the analysis result of sevral of the most important libraries for React.

<img src="https://ws2.sinaimg.cn/large/006tNbRwly1fwvwi2sz4ej30ge0fw404.jpg" width="40%" /><img src="https://ws1.sinaimg.cn/large/006tNbRwly1fwvwe4wo46j30gg0fgwfh.jpg" width="40%" />
...
Static analysis tools such as CODEBEAT and CodeFactor can only analyze the code  line by linefrom the surface layer, and can not uncover the relationships between files and even modules. Nevertheless, they do help find errors and discover trends at the code level.
...
![Coverage on Facebook/React](https://ws3.sinaimg.cn/large/006tNbRwgy1fwwe81jn80j31kw0seu0x.jpg)
...
<img src="https://ws4.sinaimg.cn/large/006tNbRwgy1fwweol3lhgj30rg13wk90.jpg" alt="Details of Coverage on Facebook/React"  width=40%>
...
## 10. Evolution-Perspective	[>](https://github.com/liyihann/react/wiki/10.Evolution-Perspective)
...
![evolution](https://ws4.sinaimg.cn/large/006tNbRwly1fwzbhzaw5lj30zg0l8agy.jpg)
...
## 11. Conclusion	[>](https://github.com/liyihann/react/wiki/11.Conclusion)

## 12. References	[>](https://github.com/liyihann/react/wiki/12.References)
