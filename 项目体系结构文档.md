...
## Abstract
React is a declarative, efficient, and flexible JavaScript library for building user interfaces which allows developers compose complex UIs from components. It was first created for the development of Facebook. Lately it was found easy and convenient to use so that it had its first initial public release. And in this document, we will take a look at React from the shallower to the deeper. At first, we show the Stakeholders of React. Then we analyze its architecture nore vividly from several perspectives including context view, development view, deployment view, functional view and performance and scalability perspective. Code tools are used to evaluate the technical debts. At last, the whole process of React evolution is stated in the last part of the article.
## Table of Contents
