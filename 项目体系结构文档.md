...
## Abstract
React is a declarative, efficient, and flexible JavaScript library for building user interfaces which lets developers compose complex UIs from components. It was first created for the development of Facebook. Lately it was found easy and convenient to use so that it had its first initial public release. And in this document, we will take a look at React from the shallower to the deeper. At first, we will show the Stakeholders of React. Then we discuss the development view which outlines how React is developed and the architecture of React. Functional view talks about the functionalities while Performance is also discussed using code tools. At last, the whole process of React evolution is stated in the last part of the article.
## Table of Contents
...
<div align="center"><img src="https://ws4.sinaimg.cn/large/006tNbRwgy1fx2xfdoj4fj30uu0lw7fk.jpg" alt="Power Interest Grid" width="100%" /><i><b>Figure2</b>  Power interest grid of React</i></div>
...
<div align="center"><img src="https://ws3.sinaimg.cn/large/006tNbRwgy1fx2xhnhqmij314y0miq82.jpg" alt="codeline" width="100%" /><i><b>Figure4</b>  Code organization of React</i></div>
...
React has some relaively independent modules. These modules can be used out of React to build a web page, but their main purpose is working together to build a React web page.

React's module organization is showing below. 

<div align="center"><img src="https://i.imgur.com/g84MNEQ.png" alt="module" width="100%" /><i><b>Figure5</b> Module organization of React</i></div>
...
**react**: This module contains the functionality necessary to define React elements, instances and components. It is the core part of React and interact with other modules to finally form a web page.
...
**loose-envify**: loose-envify is a JavaScript package which is used for selectively replace Node-style environment variables with plain strings.
...
The following figure shows a complete life cycle of React projects:

   <div align="center"><img src="https://ws4.sinaimg.cn/large/006tNbRwly1fwzaz94mx2j30kk0p0dhq.jpg" alt="lifecycle" width="100%" /><i><b>Figure12</b>  Life cycle of React projects</i></div>
...
We used a JavaScript web frameworks benchmark<a href="#ref_perf1">[2]</a> to compare performance of various versions of several of the most famous modern JS framework such as React, Angular, Vue and so on. This test used duration and memory usage as two indicator. The results are as follows:
...
<div align="center"><img src="https://ws4.sinaimg.cn/large/006tNbRwly1fwzs72sdrwj30s80hgt96.jpg" alt="throughoutput" width="100%" /></div>
<div align="center"><i><b>Figure15</b>  Throughoutput of React(DOMServer) and other templating methods</i></div>
...
React components encourage a unidirectional data flow and make state explicit and data can only be entered into JSX elements through descriptive properties. Because of this mechanism, developers must consider its interface when creating new components so that they can communicate with other different components. Inside the component you usually access the properties.The attributes provides a descriptive API and as long as they don’t change there is no regression if the component is changed. This is very similar to functional programming: new modules can be continually created, which increases scalability of the whole software system.

What's more, since React is writen in pure JavaScript, we can rely on traditional ways to organise code to make it robust and scalable. React perfectly encapsulates the underlying functionality, so in this way, a big number of developers can working behind one component without being affected.<a href="#ref_perf3">[4]</a>
...
With inspiration of XHP, an HTML component framework for PHP being used at Facebook, React was developed  from FaxJS which was an innovation of  Facebook before 2013, in order to make it more efficient and easier to re-render the application. <a href="#ref_evo1">[5]</a>
...
<div align="center"><img src="https://ws1.sinaimg.cn/large/006tNbRwgy1fx2xqife3oj310d0nbthm.jpg"  width=100%></div>
...
From several software architecture perspectives, we summarised the React to help readers understand, use and be able to contribute to the project. <!--(这里放个结论，例如：The analysis of the React project has led to the conclusion that React has an interesting, yet complex architecture.)-->

First of all, in the **Stakeholder Analysis**, we discussed various roles of stakeholders involved in React according to the classification method of Rozanski and Woods. In order for a more precise illustration, we deliberately sent an e-mail to the manager of React and got a positive reply. React is widely used in designing Web UI and accepts contributions from a wide variety of developers on Github. The whole project is maintained by core members who claim not to have specific roles like testers and developers. They aim to offer a more concise and efficient way to develop web pages.

Secondly, the **Context View** showed the relations, platforms, dependencies and external entities that React uses. Therefore, readers could get a clear view of the interactions of React.

Thirdly, in the **Development View**, design principles and code organization of React were discussed in details. 
...
What's more, in the functional view, we showed several key features of React, which included **JSX**, **Virtual DOM**, **Component** and **State & Props**.

In addition to these four views, we also studied React from other perspectives. From the **Performance and Scalability Perspective**, a more detailed view of its architecture was displayed. Performance usually refers to its ability to satisfy users' requests simultaneously. And scalability focuses on the ability to handle the growth in its processing power and increased workload of a software system.

In the **Technical Debt** section, we used tools to analyze technical debts within React such as code duplication, testing debt and so on.
...
Raised in 2014, React is still thriving in the field of web page development. Now, core members of React are paying attention to React Native which may bring a revolutionary change to the application development on mobile devices. <!--(The overall analysis of React shows that projects like this truly benefit greatly from the open-source environment. The flexible architecture, a group of passionate developers and contributors and a focus on testing have gotten React where it is today, while making it ready to evolve even further throughout the years to come.)-->
...
<a name="ref_perf1">[2]</a>  [Results for js web frameworks benchmark – round 6](https://www.stefankrause.net/js-frameworks-benchmark6/webdriver-ts-results/table.html)

<a name="ref_perf2">[3]</a>  [The Performance Cost of Server Side Rendered React on Node.js](https://malloc.fi/performance-cost-of-server-side-rendered-react-node-js)

<a name="ref_perf3">[4]</a>  [How React Makes Web Development Scalable](https://blog.codecentric.de/en/2016/05/how-react-makes-web-development-scalable/)

<a name="ref_evo1">[5]</a>  [The Evolution Of React — DashBouquet](https://dashbouquet.com/blog/frontend-development/the-evolution-of-react)
