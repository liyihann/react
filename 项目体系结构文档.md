...
In this way, React can use keys to locate the position and add node much more efficiently.<a href="#ref_func6">[6.2.1]</a><a href="#ref_func7">[6.2.2]</a>
...
We used a JavaScript web frameworks benchmark<a href="#ref_perf1">[2]</a> to compare the performance of various versions of several of the most famous modern JS framework such as React, Angular, Vue and so on. This test used duration and memory usage as two indicators. The results are as follows:
...
With the inspiration of XHP, an HTML component framework for PHP being used at Facebook, React was developed from FaxJS which was an innovation of  Facebook before 2013, in order to make it more efficient and easier to re-render the application. <a href="#ref_evo1">[5]</a>
...
<a name="ref_func6">[6.2.1]</a>  [从零开始实现一个React（一）：JSX和虚拟DOM](https://github.com/hujiulong/blog/issues/4)

<a name="ref_func7">[6.2.2]</a>  [虚拟DOM介绍](https://www.jianshu.com/p/616999666920)

<a name="ref_tec6">[8.2.1]</a>  [Avoiding Technical Debt: An Intro to Software Testing](https://www.skillgigs.com/blog/avoiding-technical-debt-an-intro-to-software-testing/)
