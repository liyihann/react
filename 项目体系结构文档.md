...
We used a JavaScript web frameworks benchmark<a href="#ref_perf1">[10]</a> to compare the performance of various versions of several of the most famous modern JS framework such as React, Angular, Vue and so on. This test used duration and memory usage as two indicators. The results are as follows:
...
<a name="ref_perf1">[10]</a>  [Results for js web frameworks benchmark – round 6](https://www.stefankrause.net/js-frameworks-benchmark6/webdriver-ts-results/table.html)

<a name="ref_perf2">[11]</a>  [The Performance Cost of Server Side Rendered React on Node.js](https://malloc.fi/performance-cost-of-server-side-rendered-react-node-js)

<a name="ref_perf3">[12]</a>  [How React Makes Web Development Scalable](https://blog.codecentric.de/en/2016/05/how-react-makes-web-development-scalable/)
