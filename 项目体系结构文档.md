...
From several software architecture perspectives, we summarised the React to help readers understand, use and be able to contribute to the project.

(这里放个结论，例如：The analysis of the React project has led to the conclusion that React has an interesting, yet complex architecture.)
