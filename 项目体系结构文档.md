...
In this way, React can use keys to locate the position and add node much more efficiently. 
...
In addition to these four views, we also studied React from other perspectives. From the **Performance and Scalability Perspective**, a more detailed view of its architecture was displayed. Performance of React is relatively better than its competitors. Key features of React guarantee the robustness and scalability of web development of programmers. 
